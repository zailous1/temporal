...
func (v *VisualizationWebSocketServer) Start() error {
	v.logger.Info("Starting visualization WebSocket server for history service", 
...
func (v *VisualizationWebSocketServer) Stop(ctx context.Context) error {
	v.logger.Info("Stopping visualization WebSocket server for history service")
...
func (v *VisualizationWebSocketServer) HandleWebSocket(w http.ResponseWriter, r *http.Request) {
	...
	v.logger.Info("New visualization client connected to history service", tag.NewStringTag("client_id", clientID))
	...
	v.logger.Info("Visualization client disconnected from history service", tag.NewStringTag("client_id", clientID))
}
